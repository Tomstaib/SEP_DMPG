...
class TestCases(unittest.TestCase):
    ...
    def test_server_initialization(self):
        ...
        assert server.queue_order == QueueType.FIFO  # Default queue order should be FIFO
    ...
    def test_source_validate_probabilities(self):
        ...
        assert sum(prob for _, prob in source.next_components) == 100  # Check if probabilities sum up to 100
