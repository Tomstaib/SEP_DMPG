...
def main():
    ...
    modelname = "CherryCherry"
    scenarioname = "Lady"
    user_name = "DieterBohlen"
    run_replications(modelname, scenarioname, user_name, model=setup_model4_1, minutes=10080, num_replications=100, multiprocessing=False, save_pivot_to_database=True)
